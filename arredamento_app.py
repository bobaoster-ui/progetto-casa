...
st.set_page_config(page_title="Monitoraggio Arredamento V35.0", layout="wide", page_icon="💎")
    ...
    if "Riepilogo" in sel:
        ...
        if not df_real.empty:
            ...
            if st.button("📑 Scarica Report PDF Professionale"):
                ...
                st.download_button("📥 Scarica PDF", bytes(pdf_output), "Report_Arredamento.pdf", "application/pdf")
        ...
        with st.form("form_wish"):
            w_cfg = {
                "link_fattura": st.column_config.LinkColumn("🔗 Sito Web"),
